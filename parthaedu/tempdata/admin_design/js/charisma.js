...
function docReady(){
	...
	var elf = $('.file-manager').elfinder({
		url : base_url+'misc/elfinder-connector/connector.php'  // connector URL (REQUIRED)
	}).elfinder('instance');
	...
	$('#file_upload').uploadify({
		'swf'      : base_url+'misc/uploadify.swf',
		'uploader' : base_url+'misc/uploadify.php'
...
//<a href="#" class="gallery-edit btn"><i class="icon-edit"></i></a>
