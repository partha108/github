...
<div class="mail_template_wrapper" style=" width: 100%">
    ...
    // $CI= & get_instance();
    foreach($admin_details_by_email_array as $admin_details_by_email_array)
    {}
    ...
    <div>
        ...
        <p>Your Username:  <?php echo $admin_details_by_email_array->username;?></p>
        <p>Your Password:  <?php echo $admin_details_by_email_array->password;?></p>
