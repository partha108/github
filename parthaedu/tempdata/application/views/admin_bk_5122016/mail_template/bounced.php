...
<div style=" width: 100%">
    ...
    <div>
        ...
        <p>We have not received amount of <?php echo $total_amt;?>  with check no <?php echo $check_no;?> Bank <?php echo $bank_name;?>. </p>
        <p> Because your cheque will  bounced Please Pay The Amount As Soon As Possible.</p>
