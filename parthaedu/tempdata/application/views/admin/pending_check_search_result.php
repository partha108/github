                ...
                <table class="table table-striped table-bordered bootstrap-datatable">
                    ...
                    <tr>
                       ...
                       // echo $batch_name;
                        ...
                        @$subject_details = $this->common_model->add_course_data('tbl_subject','subject_id',$subject_id);
                       // @$batch_detail = $this->common_model->add_course_data('tbl_add_course_subject_to_student','add_course_id',$course_id);

                            @$batch_detail = $this->common_model->common($table_name='tbl_add_course_subject_to_student',$field=array(),$where=array('add_course_id'=>$course_id,'subject_name'=>$subject_id),$where_or=array(),$like=array(),$like_or_array=array(),$order=array(),$start='',$end='',$where_in_array=array());
                        ...
                        <td><?php echo @$pd->roll_no;/*."/<br>".@$pd->student_id;*/?></td>
                        ...
                        <td><?php if(@$pd->payment_head_name == "Exam Fees"){echo "Exam Fee";}else if(@$pd->payment_head_name == "Reg Fees"){echo "Reg Fees";}else {echo @$payment_head_details[0]->payment_head_name;}?></td>
                        <td><?php echo @$course_details[0]->course_name;?></td>
                        <td> <?php echo @$pd->class_name; ?></td>
                        <td><?php if($pd->subject_id == ""){echo "";}else{echo $subject_details[0]->subject_name;}//echo @$pd->subject_name;?></td>
                        <td><?php
                            if($batch_name != 0)
                            {
                                if($pd->subject_id == "")
                            ...
                            {
                                if($pd->subject_id == ""){echo "";}else{echo $batch_detail[0]->batch_name;}
                            }?>
                            <?php /*if($pd->subject_id == ""){echo "";}else{echo $batch_detail[0]->batch_name;}*/?></td>
                    </tr>
