    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header well" data-original-title>
                <h2><i class="icon-user"></i>View Course</h2>
            </div>
                ...
                <form method="post" action="<?php echo base_url('index.php/studentlist/edit_course_to_student') ?>">
                    <table id="tbl" class="table table-striped table-bordered bootstrap-datatable datatable">
                        ...
                        <tr>
                            ...
                            <th>Academic Year</th>
                            <td><select  name="add_ac_year" id="add_ac_year" onchange="add_show_course(this.value)" disabled>
                            ...
                            <th>Course</th>
                            <td>
                                <select id="edit_db_course" name="add_course" onchange="add_show_class(this.value);" disabled>
                                    <?php
                                    foreach (@$course as $course_list)
                                    {
                                        @$cl = $course_list->course_name;
                                        @$rpl_cl = $course_list->course_id;
                                        ?>
                                        <option value="<?php echo @$rpl_cl;?>" <?php if($res->course_name == $cl){ echo "selected";}?>><?php echo $cl;?></option>
                                        <?php
                                    }
                                    ?>
                            ...
                            <th>Class</th>
                            <td><select id="class_id" name="add_class" onchange="add_show_batch(this.value);add_show_subject(this.value);" disabled>
                    ...
                    <script>
                        ...
                        jQuery('a.add-author').click(function(event){
                            ...
                            newRow += '<td>Batch</td><td><select disabled id="batch_id_'+counter+'" name="batch_id[]" >';
                            newRow += strr1;
                    ...
                    if($count == 0)
                    {
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable authors-list">
                            <tr>
                                ...
                                <td>Batch</td>
                                <td><select disabled id="batch_id_0" name="batch_id[]">
                    ...
                    <table class="table table-striped table-bordered bootstrap-datatable datatable authors-list">
                        ...
                        foreach($sub_data as $ph)
                        {
                            ...
                            $course_id = $ph->add_course_id;
                            //$bat_name = $this->common_model->edit_subject_payment_details_model('tbl_add_course_subject_to_student','add_course_id',$course_id);
                            //echo $bat_name[0]->batch_name;
                               // echo $batch_name;
                            ?>
                            <tr>
                                <td>
                                    <select disabled id="sub_id_<?php echo $c;?>" class="sub_id" name="add_subject[]" onchange="subject_id_details(<?php echo $c;?>,this.value);sub_fee(<?php echo $c;?>,this.value);sub_payment_detils(<?php echo $c;?>,this.value);sub_payment_amt(<?php echo $c;?>,this.value);sub_payment_vat(<?php echo $c;?>,this.value);sub_payment_vat_amt(<?php echo $c;?>,this.value);sub_payment_total_amt(<?php echo $c;?>,this.value);sub_payment_to_date(<?php echo $c;?>,this.value);sub_payment_frm_date(<?php echo $c;?>,this.value); /*add_show_subject_fees(this.value)*/">
                                        <option value="0">---Select Subject---</option>
                                        <?php
                                        foreach($subject_name as $sn)
                                        {
                                ...
                                for($i=0;$i<count($pay_det);$i++){
                                    ...
                                    if($pay_sub_payment_head_name == "Exam Fees"){}
                                        ...
                                        <td style="display: none" id="subject_id_details_<?php echo $c;?>" ><input type="text" name= "subject_id_detail[]" value="<?php echo $pay_sub_id;?>">'</td>
                                        <td style="display: none" id="payment_head_details_<?php echo $c;?>" ><input type="text" name= "payment_detail[]" value="<?php echo $pay_sub_payment_head_name;?>"></td>
                                        <td style="display: none" id="payment_head_details_amt_<?php echo $c;?>"><input type="text" name= "payment_detail_amt[]" value="<?php echo $pay_sub_payment_head_amt;?>"></td>
                                        <td style="display: none" id="payment_head_details_vat_<?php echo $c;?>"><input type="text" name= "payment_detail_vat[]" value="<?php echo $pay_sub_payment_head_vat;?>"></td>
                                        <td style="display: none" id="payment_head_details_vat_amt_<?php echo $c;?>" > <input type="text" name= "payment_detail_vat_amt[]" value="<?php echo $pay_sub_payment_head_vat_amt;?>"></td>
                                        <td style="display: none" id="payment_head_details_total_amt_<?php echo $c;?>" > <input type="text" name= "payment_detail_tot_amt[]" value="<?php echo $pay_sub_payment_head_tot_amt;?>"></td>
                                        <td style="display: none" id="payment_head_details_to_dt_<?php echo $c;?>" > <input type="text" name= "payment_detail_to_date[]" value="<?php echo $pay_sub_payment_head_to_date;?>"></td>
                                        <td style="display: none" id="payment_head_details_frm_dt_<?php echo $c;?>"> <input type="text" name= "payment_detail_frm_date[]" value="<?php echo $pay_sub_payment_head_frm_date;?>"></td>

                                    <?php }}?>


                                <td><select disabled id="batch_id_<?php echo $c;?>" name="batch_id[]">
