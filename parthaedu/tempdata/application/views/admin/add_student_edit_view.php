...
<div id="content" class="span10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li> <a href="<?php echo base_url(); ?>studentlist">Edit Student</a> </li>
        </ul>
    </div>
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <div class="box-content">
                    <?php echo form_open_multipart('studentlist/edit_student'); ?>
                    <div>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                            ...
                                            <tr>
                                                <td>Exam id</td>
                                                <td><input type="text"  name="student_roll_no" value="<?php echo $sd->roll_no;?>"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input  name="email" type="text"  value="<?php echo $sd->student_email;?>"></td>
                                        ...
                                        <div class="add_more_edu_list" id="add_more_edu_0">
                                            <table class="table table-striped table-bordered bootstrap-datatable datatable" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text"  name="mother_mobile_no" value="<?php echo $sd->guardian_phone_no; ?>"></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </td>
