    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header well" data-original-title>
                ...
                <a href="<?php echo base_url()?>index.php/pending_cheque/excel"><h2 class="down">Download Excel</h2></a></span>
            </div>
            <div class="box-content">
                <?php echo $this->session->flashdata('update_message');  ?>
                <div><!--<a class="btn btn-primary" href="javascript:void(0)" onclick="return open_add_model()" > Add Student </a>-->
                    <table class="tblborder" style="width: 100%">
                        <tr>
                            <td width="15%">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php
                        ...
                        <td style="width:1px"><input type="checkbox" name="check_id" id="<?php echo @$pd->ack_no;?>"  class="chtest_test"
                                                     onClick="single_check_box_checked(/*this.checked,*/this.id)" value="<?php echo @$pd->ack_no;?>"/></td>
                        ...
                        <td><?php if(@$pd->check_status == '3'){echo "In Process";}?></td>
                        <td><?php echo $total_fees;?></td>
                        <td><?php echo $total_vat_amt;?></td>
                        <td><?php echo $total_amt;?></td>
                        <td> <a class="btn btn-danger" href="#" title="Delete Cheque" onclick="delete_cheque(<?php echo @$pd->ack_no;?>)"> <i class="icon-trash icon-white"></i>  </a>
                            <a class="btn btn-info btn-sm" href="#" title="Bounced Cheque" onclick="bounced_cheque(<?php echo @$pd->ack_no;?>)"> <i class="icon-trash icon-info-sign"></i>  </a></td>
                    </tr>
...
<script>
    ...
    function bounced_cheque()
    {
       ...
       // alert(checkboxValue);
        if(checkboxValue!='')
        {
            window.location = base_url+'index.php/pending_cheque/bounced_cheque/'+checkboxValue;
        }
        else
        {
            alert('Please Select  check box.');
