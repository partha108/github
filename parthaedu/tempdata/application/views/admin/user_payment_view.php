	  ...
	  if($this->uri->uri_string()=='fees')
			{  
             ...
             <table class="payment-box">
             	<tr><td><strong>Name</strong> </td><td> <?php if(isset($name)){ echo $name;}?></td><td><strong>Session Charge</strong> </td><td><?php echo $user_det[0]->session_charge?></td></tr>
             	<tr><td><strong>Registration No.</strong> </td><td> <?php  echo $registration_no; ?></td><td><strong>Security Deposit</strong> </td><td><?php echo $user_det[0]->security_deposit?></td></tr>
             	<tr><td><strong>Class</strong> </td><td>  <?php  foreach($class as $classinfo):
                        if($class_id==$classinfo->id){ echo $classinfo->name;}?>
                      <?php endforeach;?>
                   </td><td><strong>Total Amount</strong> </td><td> <?php echo $user_det[0]->yearly_fees?></td></tr>
             	<tr><td><strong>Year</strong> </td><td> <?php  for($y=0; $y<count($year); $y++){  
				   if($year[$y]== $year_value){ echo $year[$y];}?>
                 <?php }?> </td><td><strong>Total Paid</strong> </td><td>  <?php echo $user_det[0]->paid?></td></tr>
             	<tr><td><strong>Monthly Fees</strong> </td><td>  <?php echo $user_det[0]->class_fees?></td><td><strong>Total Due</strong> </td><td> <?php echo $user_det[0]->yearlydue?></td></tr>
             </table>
            ...
            <tr>
             <td><?php echo $count ;?></td>
              ...
              <table class="payment-box">
              	...
              	<?php if($row['session_charge']!=0){?>
              	<tr>
              		<td><strong>Session charge</strong></td>
              		<td> +<?php echo $row['session_charge'];?></td>
              	</tr>
              	<?php }?>
              	<?php if($row['security_deposit']!=0){?>	
              	<tr>
              		<td><strong>Security Deposit</strong></td>
              		<td>+<?php echo $row['security_deposit'];?></td>
              	</tr>
              	<?php }?>	
              	<?php if($row['concession']!=0){?>	
              	<tr>
              		<td><strong> Concession</strong></td>
              		<td>-<?php echo $row['concession'];?></td>
              	</tr>
              	<?php }?>
              	<?php if($row['specialfees']!=0){?>	
              	<tr>
              		<td><strong> Special Chrge</strong></td>
              		<td>+<?php echo $row['specialfees'];?></td>
              	</tr>
              	<?php }?>
              	<tr>
              		<td><strong> Class Fees</strong></td>
              		<td>+ <?php echo $user_det[0]->class_fees?></td>
              	</tr>
              		<tr>
