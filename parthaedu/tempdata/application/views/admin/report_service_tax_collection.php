        ...
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <div><!--<a class="btn btn-primary" href="javascript:void(0)" onclick="return open_add_model()" > Add Student </a>-->
                    ...
                    <input type="radio" name="search_data" value="search_by_name">Search By Name
                    <div id="frm1" style="display: none">
                        <form method="post" action="<?php echo base_url('report_module/search');?>">
                            <input type="text" name="txt_search_data" id="txt_search_data" placeholder="Enter Student name">
                            <input type="text" name="txt_rec_no" id="txt_rec_no" placeholder="Enter recepit_no">
                            To<input type="text" id="to_date" name="to_date">&nbsp;&nbsp;&nbsp;
                            Form<input type="text" id="frm_date" name="frm_date">
                            <select name="payment_head">
                                ...
                                <?php } ?>
                                <option value="Discount">Discount Fee</option>
                                <option value="Add_fee">Additional Fee</option>
                    ...
                    <table class="tblborder" width="15%">
                        <tr>
                ...
                <table class="table table-striped table-bordered" id="tbl_data">
                    ...
                    foreach(@$payment_details as $pd)
                    {
                        ...
                        <tr>
                            ...
                            <td><?php   if($pd->cancel_date == "0000-00-00" || $pd->cancel_date == ""){echo "";}else{echo date('d-m-Y',strtotime(@$pd->cancel_date));}?></td>
                    ...
                    <tr>
                        ...
                        <td colspan="15" style="text-align:right"><b>Grand Total</td>
                        <td><?php echo $tot_head_fee;?></td>
                        <td><?php echo $tot_head_vat_amt;?></td>
                        <td ><?php echo $tot_head_amt ;?></td
