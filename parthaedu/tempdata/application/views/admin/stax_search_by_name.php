    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header well" data-original-title style="text-align: right">
                ...
                <form method="post" action="<?php echo base_url()?>index.php/report_module/search_excel">
                    <input type="hidden" name="txt_search_data">
            ...
            <div class="box-content">
                ...
                <div><!--<a class="btn btn-primary" href="javascript:void(0)" onclick="return open_add_model()" > Add Student </a>-->
                    ...
                    <input type="radio" name="search_data" value="search_by_class" checked>Search By Class
                    ...
                    <div id="frm2" style="display: block"><form method="post" action="<?php echo base_url('report_module/search_by_class');?>">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        foreach($search as $tot_amt_clear_cheque)
                        {
                        ...
                        foreach($search as $tot_amt_nv_cheque)
                        {
