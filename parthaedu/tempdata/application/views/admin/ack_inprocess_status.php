...
//echo convert_number_to_word(1800);
?>
<?php
$total_fees =0;
$total_vat_amt =0;
...
<center>
	<div style="border: 1px solid black;width: 60%">
		...
		<table width="100%" class="tbl_font_size">
			...
			?>
			<tr><td colspan="5"><center><b><span style="font-size:20px">Acknowledgement</span></b></center></td></tr>
			<tr>
				<?php foreach($ack_details as $rc){
				...
				?>
				<td class="receipt" colspan="2">Acknowledgement No:<?php echo $rc->ack_no;?></td>
			...
			<tr>
				<td colspan="4" class="receipt">Total Amount Received:<?php echo $total_amt." (".convert_number_to_word($total_amt).")"; ?></td>
			</tr>
