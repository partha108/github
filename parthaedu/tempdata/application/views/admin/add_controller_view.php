    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header well" data-original-title>
                <h2><i class="icon-user"></i>Controller List</h2>
                <span style="color: red;padding-left:40px;font-size: 15px"><?php echo $this->session->flashdata('message');  ?></span>
            </div>
            <div class="box-content">

                <div><a class="btn btn-primary" href="javascript:void(0)" onclick="return open_add_model()" > Add Controller </a>
...
<div class="modal hide fade" id="myaddmodel" style="width:1000px; left:40%">
    <?php echo form_open_multipart('add_controller/sub_admin_record', array('class' => 'form-horizontal', 'id' => 'addClassFrm')); ?>
