...
class bounce_cheque extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['payment_details']= $this->common_model->pending_check('tbl_add_course_to_student_payment_details','check_status','2','payment_status','pending');
        $data['payment_det_count']= $this->common_model->common($table_name='tbl_add_course_to_student_payment_details',$field=array(),$where=array('check_status'=>'2','payment_status'=>'pending'),$where_or=array(),$like=array(),$like_or_array=array(),$order=array(),$start='',$end='',$where_in_array=array());
        ...
        $this->load->view('admin/bounce_cheque_view',$data);
    ...
    function receive_payment_model($id)
    {
        ...
        for($i=0;$i<count(array_filter($st_id));$i++)
        {
            ...
            //@$this->common_model->update_data($data, 'tbl_add_course_to_student_payment_details', 'check_no', $payment_id);
        }
    ...
    public function excel()
    {
        ...
        $payment_details = $this->common_model->pending_check('tbl_add_course_to_student_payment_details','check_status','2','payment_status','pending');
        $count = 2;
        ...
        $filename='bouncedcheque.xls'; //save our workbook as this file name
    ...
    function delete_cheque($id)
    {
        ...
        // exit;
        redirect('bounce_cheque');
    }
    function bounced_cheque()
    {
        if($this->user_role!=1)
        {
            $this->load->library('permission_lib');
        ...
        @$this->common_model->update_data($data,'tbl_add_course_to_student_payment_details','payment_id',$id);

        redirect('bounce_cheque','refresh');
    }
