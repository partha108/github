...
class salary extends CI_Controller {
	...
	public function index()
	{
		...
		{	
			...
			{			
	$data['user_list']=$this->salary_payment_lib->user_paymentlist($data['name'],$data['user_id'],$data['month_value'],$data['month_value'],$data['year_value'],'',$role_id,$data['class_fees']);
			}
	...
	$data['user_list']=$this->salary_payment_lib->user_paymentlist($data['name'],$data['user_id'],1,12,$data['year_value'],'',$role_id,$data['class_fees']);
			...
			//echo $data['class_id'];	exit;		
$data['user_list']=$this->salary_payment_lib->user_paymentlist($data['name'],$data['user_id'],1,12,$data['year_value'],$data['class_id'],$role_id,$data['class_fees']);;
		//echo "<pre>"; print_r($data['user_list']); exit;		
		}
		...
		if(isset($_GET['payuser']) )
		{
			$this->load->view('admin/teacher_payment_view',$data);
		}else{
