                    ...
                    <div class="col-md-12">
                        ...
                        <div class="kf_inr_ban_des">
                        	<div class="inr_banner_heading">
								<h3>Achivement Results</h3>
                        	</div>
                           
                            <div class="kf_inr_breadcrumb">
								<ul>
									<li><a href="<?php echo base_url();?>">Home</a></li>
									<li><a href="#">Achivement Results</a></li>
								</ul>
							</div>
                        </div>
	 					...
	 					<div class="col-md-8">
	 						...
	 						<div class="kf_courses_detail_wrap">
	 							<div class="courses_detail_heading">
	 								<h4>Achivement Result Sheets</h4>
	 							</div>
										...
										<div role="tabpanel" class="tab-pane <?php if($j==1){?>active<?php }?>" id="coursedetails<?php echo $j;?>">
											...
											<div class="kf_courses_detail_des">
												<div class="course_heading">
													<h4><?php echo $tr2->test_name;?></h4>
                                                    <i class="text-danger">Uploaded on <?php echo $tr2->upload_date;?></i>
