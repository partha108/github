        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Add Notice</strong></h2>
            ...
            <div class="col-lg-12 portlets">
             ...
             <div class="col-md-12">
				...
				if($this->uri->segment(4)){
					echo form_open("admin/admin/update_notice/".$this->uri->segment(4),array("class"=>"form-horizontal"));?>
                   ...
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"> Update Notice</button>
                  
                  </div>
                <?php echo form_close();
				}else{
					echo form_open("admin/admin/add_notice",array("class"=>"form-horizontal"));?>
                   ...
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"> Add Notice</button>
                  ...
                  <div class="filter-left">
                    <table class="table table-dynamic">
                      ...
                      <tr>
                       ...
                       <td><?php echo $stud->add_date;?></td>
                          <td><?php echo $stud->content;?></td>
                         
                         
                          <td>
                          <a href="notice/<?php echo $stud->id;?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a> 
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/notice_del/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
