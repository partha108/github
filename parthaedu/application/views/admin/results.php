        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Achivement Results</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
              
                <li><a href="<?php echo base_url();?>">Dashboard</a>
                </li>
                <li class="active"> Achivement Results</li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Achivement Results</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/result_upload",array("class"=>"form-horizontal"));?>
                  <div class="form-group">
                  <select class="form-control" name="class" data-search="true" required>
                    <option value="">Select Class/Course</option>
                   <?php foreach($cl as $cl){?>
				   		<option value="<?php echo $cl->class_name;?>"><?php echo $cl->class_name;?></option>
                        <?php }?>
      			  </select>
                  </div>
                   <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                  <input type="file" name="rfile[]" multiple="multiple" class="form-control" required />
                  </div>
                  
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Upload File</button>
                  ...
                  <div class="filter-left">
                    <table class="table table-dynamic">
                      ...
                      <tr>
                        ...
                        <td><?php echo $stud->for_class;?></td>   
                        <td><?php echo $stud->year;?></td>
                       	<td><?php echo $stud->upload_date;?></td>
                         
                          <td>
                          <a href="<?php base_url();?>result_edit/<?php  echo $stud->id;?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
    ...
    <script>
		$(document).ready(function(){ 
			$(".inremove").click(function(e){ e.preventDefault();
				var id="r"+$(this).attr("href");
			...
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/ach_result_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
