        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Newsletter Subscription</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Newsletter Subscription</strong> </h3>
                </div>
                <div class="panel-content">
               
             <?php 
			   echo form_open("admin/admin/send_newsemail",array("class"=>"form-horizontal"));?>
                  
                    <div class="form-group">
                    <select name="email[]" multiple="multiple" class="form-control">
                    	<option value="all">All</option>
                        <?php foreach($news as $es){?>
                        <option value="<?php echo $es->email;?>"><?php echo $es->email;?></option>
                        <?php }?>
                    </select>
                    </div>
                    <div class="form-group">
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/news_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
