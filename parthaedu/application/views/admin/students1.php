        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Upload Results</strong></h2>
             ...
             <div class="col-md-12">
                <form class="form-horizontal" role="form">
                  ...
                  <input type="file" name="file" class="form-control" />
                   ...
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Upload Excel</button>
                  <?php echo anchor('admin/admin/add_new_student', 'Add New Student',array('class'=>'btn btn-info'));?>
                  </div>
                </form>
			  </div>
           ...
           <hr/>
                  <div class="filter-left">
                    <table class="table table-dynamic table-tools">
                      ...
                      <tr>
                        <td><?php echo $stud->roll_number;?></td>
                        <td><?php echo $stud->student_name;?></td>
                          <td><?php echo $stud->courses;?></td>
                          <td><?php echo $stud->stream;?></td>
                          <td><?php echo $stud->year." year [Semester-".$stud->semester."]";?></td>
                          <td><a href="#" class="btn btn-sm btn-dark"><i class="fa fa-eye"></i></a><a href="#" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a><a href="#" class="btn btn-sm btn-danger"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                <?php }?>
                      </tbody>
                    </table>
