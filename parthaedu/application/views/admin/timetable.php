        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Upload Time Table</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-file-file-o"></i> <strong>Time Table Upload</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/time_table_upload",array("class"=>"form-horizontal"));?>
                  ...
                  <option value="XII">Class XII</option>
                    ...
                    <div class="form-group">
                    <input type="text" name="exam" class="form-control" placeholder="Time Table Title" />
                    </div>
           ...
           <hr/>
                  <div class="filter">
                    <table class="table table-dynamic">
                      ...
                      <td>  <?php echo $stud->upload_date;?></td><td><?php echo $stud->test_name;?></td>
                       
                          <td><?php echo $stud->for_class;?></td>
                          <td><?php echo $stud->filename;?></td>
                         
                          <td><a href="<?php echo base_url();?>uploads/<?php echo $stud->filename;?>" download class="btn btn-sm btn-dark"><i class="fa fa-download"></i></a>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/timetabledelete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
