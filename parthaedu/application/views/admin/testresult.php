        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Upload Test Results</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Result pdf Upload</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/test_result_upload",array("class"=>"form-horizontal"));?>
                  ...
                  <option value="XII">Class XII</option>
                    ...
                    <div class="form-group">
                    <input type="text" name="exam" class="form-control" placeholder="Test Name" />
                    </div>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/testr_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
