        ...
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-lg-12 portlets">
             ...
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/more_add/".$this->uri->segment(4),array("class"=>"form-horizontal"));?>
           ...
           <hr/>
                  <div class="filter-left">
                    <table class="table table-dynamic">
                      ...
                      <tbody>
                       <?php $i=1;$pics=explode(",",$result->file);
					   foreach($pics as $stud){
						   ?>
                      <tr>
                        <td style="width:200px;">
            <img class="img img-responsive pull-left" src="<?php echo base_url();?>uploads/<?php echo $stud;?>" />
                        </td>
                       
                          <td>
                          
                          <a href="<?php echo $stud;?>" id="<?php echo $result->id;?>" class="btn btn-sm btn-danger resdelete"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                <?php $i++;}?>
                      </tbody>
                    </table>
		...
		$(document).ready(function(){ 
			...
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/ach_result_delete1/"+id+"/"+file,
                        data: { id : id } 
                    }).done(function(data){
                    //alert(data);
						//$("#streams").html(data);	
