            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Edit Album <?php echo str_replace("%20"," ",$this->uri->segment(4));?></strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/add_album1",array("class"=>"form-horizontal"));?>
                   
                    <input type="hidden" name="alname" value="<?php echo str_replace("%20"," ",$this->uri->segment(4));?>" class="form-control" placeholder="Album Name" required/>
                 
                   
                   
                  
                  <div class="form-group">
                  <input type="file" name="afile" class="form-control" required />
                  </div>
                  
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Add Image</button>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/album_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
