        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Manage Team/Faculty</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
              
                <li><a href="<?php echo base_url();?>">Dashboard</a>
                </li>
                <li class="active">Faculty/Team</li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3> <strong>Add New Faculty</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php if($this->uri->segment(4)){
				echo form_open_multipart("admin/admin/update_team/".$this->uri->segment(4),array("class"=>"form-horizontal"));?>
                   <div class="form-group">
                    <input type="text" name="name" value="<?php echo $eid->name;?>" class="form-control" placeholder="Name" required/>
                    </div>
                    <div class="form-group">
                    <input type="text" name="position" value="<?php echo $eid->position;?>" class="form-control" placeholder="Position" required />
                    </div>
                     <div class="form-group">
                  
                    <input type="text" name="edu" value="<?php echo $eid->education;?>" class="form-control" placeholder="Education & Experience" required />
                    <input type="hidden" name="oldfile" value="<?php echo $eid->image;?>" />
                    </div>
                  ...
                  <input type="file" name="tfile" class="form-control" />
                   ...
                   <div class="form-group col-md-6">
                  <img class="img img-responsive" style="width:20%; height:20%;" src=" <?php echo base_url();?>team/<?php echo $eid->image;?>" />
                  </div>
                  
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success">Update Faculty</button>
                  <a class="btn btn-default" href="<?php echo base_url();?>index.php/admin/admin/team">Cancel</a>
                  
                  </div>
                <?php echo form_close();
				}
				else
				{echo form_open_multipart("admin/admin/add_faculty",array("class"=>"form-horizontal"));?>
                   <div class="form-group">
                    ...
                    <input type="text" name="position" class="form-control" placeholder="Position" required />
                     ...
                     <div class="form-group">
                    <input type="text" name="edu" class="form-control" placeholder="Education & Experience" required />
                    </div>
                  ...
                  <input type="file" name="tfile" class="form-control" />
                   ...
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-plus"></i> Add Faculty</button>
           ...
           <hr/>
                  <div class="filter">
                    <table class="table table-dynamic">
                      ...
                      <tbody>
                       <?php $i=1;foreach($team as $stud){?>
                      <tr>
                        <td><?php echo $i;?></td>
                        <td style="width:100px;"><img class="img img-responsive"  src="<?php echo base_url();?>team/<?php echo  $stud->image;?>" /></td>
                        <td><?php echo $stud->name;?></td>
                       
                      <td><?php echo $stud->position;?></td>
                          <td><?php echo $stud->education;?></td>
                          
                         
                          <td>
                          <a href="team/<?php echo $stud->id;?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/team_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
