        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Manage Album</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Add New Album Images</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/add_album",array("class"=>"form-horizontal"));?>
                  ...
                  <input type="file" name="afile[]" multiple="multiple" class="form-control" required />
                   ...
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-picture-o"></i> Add Album</button>
           ...
           <hr/>
                  <div class="filter">
                    <table class="table table-dynamic">
                      ...
                      <tbody>
                       <?php $i=1;foreach($al as $stud){?>
                      <tr>
                       
                       
                        <td><?php echo $stud->album_name;?></td>
                       
                    
                          
                         
                          <td>
                          <a href="<?php echo base_url();?>index.php/admin/admin/add_album_images/<?php echo $stud->id;?>" class="btn btn-sm btn-success">Add Images</a>
                          <a href="<?php echo base_url();?>index.php/admin/admin/album2/<?php echo $stud->album_name;?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                          <a href="<?php echo $stud->album_name;?>" class="btn btn-sm btn-danger resdelete"><i class="fa fa-trash-o"></i></a></td>
                        </tr>
                <?php $i++;}?>
                      </tbody>
                    </table>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/album_deletefull/"+id,
                        data: { id : id } 
                    }).done(function(data){
                    // alert(data);
						//$("#streams").html(data);	
