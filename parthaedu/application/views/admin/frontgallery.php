        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Manage Front Gallery</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
              
                <li><a href="<?php echo base_url();?>">Dashboard</a>
                </li>
                <li class="active">Front Gallery</li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><strong>Add Images to Front Gallery</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/front_gallery_add",array("class"=>"form-horizontal"));?>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/front_gallery_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                    alert(data);
						//$("#streams").html(data);	
