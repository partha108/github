        <div class="page-content">
          <div class="header">
            <h2><strong>Add Testimonials</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Add Testimonials</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open_multipart("admin/admin/add_testimonials",array("class"=>"form-horizontal"));?>
                  <div class="form-group">
                  <select class="form-control" name="usertype" data-search="true" required>
                  ...
                  <option value="Parents">Parent</option>
                    ...
                    <div class="form-group">
                    <textarea name="comment" class="form-control" rows="3" placeholder="Add Your Testimonial"></textarea>
                    </div>
           ...
           <hr/>
                  <div class="filter-left">
                    <table class="table table-dynamic">
                      ...
                      <tr>
                        <td><?php echo $i;?></td>
                        <td><img class="img img-responsive" style="height:50%;" src="<?php echo base_url();?>uploads/testimonials/<?php echo $stud->image;?>" /></td>
                        <td><?php echo $stud->usertype;?></td>
                      <td><?php echo $stud->username;?></td>
                          <td><?php echo $stud->comment;?></td>
		...
		$(document).ready(function(){ 
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/testi_delete/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
