        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Contact Enquiries</strong></h2>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
              
                <li><a href="<?php echo base_url();?>">Dashboard</a>
                </li>
                <li class="active">Contact Enquiries</li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Contact Enquiries</strong> </h3>
                </div>
                <div class="panel-content">
               <?php 
			   echo form_open("admin/admin/send_contact",array("class"=>"form-horizontal"));?>
                  
                    <div class="form-group">
                    <select name="email" class="form-control">
                    	<option value="all">All</option>
                        <?php foreach($contact as $es){?>
                        <option value="<?php echo $es->email;?>"><?php echo $es->email." [".$es->name."]";?></option>
                        <?php }?>
                    </select>
                    </div>
                    <div class="form-group">
                    <input type="text" name="subject" class="form-control" placeholder="Subject" />
                     ...
                     <div class="form-group">
                    <textarea rows="10" class="cke-editor" name="message"></textarea>
                    </div>
             ...
             <hr/>
               <h4>Send Message</h4>
             <?php 
			   echo form_open("admin/admin/contact_msg",array("class"=>"form-horizontal"));?>
                  
                    <div class="form-group">
                     <select name="mobile[]" multiple="multiple" class="form-control">
                    	
                         <option value="">Select One or Multiple Contacts</option>
                    <?php foreach($contact as $stu){
						?><option value="<?php echo $stu->phone;?>"><?php echo $stu->name." [". $stu->phone."]";?></option>
                        <?php }?>
                    </select>
                    </div>
                ...
                <?php echo form_close();?>
                  ...
                  <div class="filter">
                    <table class="table table-dynamic">
                      ...
                      <tbody>
                       <?php $i=1;foreach($contact as $stud){?>
                      <tr>
                        <td><?php echo $i;?></td>
                         <td><?php echo $stud->cdate;?></td>
                        <td><?php echo $stud->name;?></td>
                        <td><?php echo $stud->email;?></td>
                         <td><?php echo $stud->phone;?></td>
                          <td><?php echo $stud->msg;?></td>
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/contactq/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
