            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header">
                  <h3><i class="fa fa-file-excel-o"></i> <strong>Add Class</strong> </h3>
                </div>
                <div class="panel-content">
               
             <div class="col-md-12">
                <?php echo form_open("admin/admin/add_class",array("class"=>"form-horizontal"));?>
                  
                    <div class="form-group">
                    <input type="text" name="class" class="form-control" placeholder="Enter Class/Course Name" />
                    </div>
                   ...
                   <div class="form-group">
          <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Add Class</button>
           ...
           <hr/>
                  <div class="filter">
                    <table class="table table-dynamic">
                      ...
                      <tr>
                        <td><?php echo $i;?></td>
                        <td><?php echo $stud->class_name;?></td>
