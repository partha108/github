        ...
        <div class="page-content">
          <div class="header">
            <h2><strong>Exam Notice</strong></h2>
            ...
            <div class="col-lg-12 portlets">
             ...
             <div class="col-md-12">
				...
				if($this->uri->segment(4)){
					echo form_open("admin/admin/update_exam/".$this->uri->segment(4),array("class"=>"form-horizontal"));?>
                  
                    <div class="form-group">
                    <input type="text" name="title" value="<?php echo $not->title;?>" class="form-control" placeholder="Notice Heading/Title" />
                    </div>
                    
                     <div class="form-group">
                    <textarea rows="10" class="cke-editor" name="content"><?php echo $not->content;?></textarea>
                    </div>
                  
                
                  
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success">Update Exam Notice</button>
                  
                  </div>
                <?php echo form_close();
				}else{
					echo form_open("admin/admin/add_exam",array("class"=>"form-horizontal"));?>
                  
                    <div class="form-group">
                    <input type="text" name="title" class="form-control" placeholder="Notice Heading/Title" />
                    </div>
                    
                     <div class="form-group">
                    <textarea rows="10" class="cke-editor" name="content"></textarea>
                    </div>
                  
                
                  
                   <div class="form-group">
                  <button type="submit" name="submit" class="btn btn-success"> Add Exam Notice</button>
           ...
           <hr/>
                  <div class="filter-left">
                    <table class="table table-dynamic">
                      ...
                      <tbody>
                       <?php $i=1;foreach($result as $stud){?>
                      <tr>
                        <td><?php echo $i;?></td>
                        <td><?php echo $stud->title;?><br/>
                       
                       <?php echo $stud->edate;?></td>
                          <td><?php echo $stud->content;?></td>
                         
                         
                          <td>
                          <a href="exam/<?php echo $stud->id;?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a> 
		...
		$(document).ready(function(){
			$(".resdelete").click(function(e){ e.preventDefault();
				...
				$(this).closest("tr").remove();
				 $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/admin/admin/exam_del/"+id,
                        data: { id : id } 
                    }).done(function(data){
                   //  alert(data);
						//$("#streams").html(data);	
    ...
    <script src="<?php echo base_url();?>assets/js/pages/search.js"></script> <!-- Search Script -->
      <script src="<?php echo base_url();?>assets/plugins/summernote/summernote.min.js"></script> <!-- Simple HTML Editor -->
    <script src="<?php echo base_url();?>assets/plugins/cke-editor/ckeditor.js"></script> <!-- Advanced HTML Editor -->
    <script src="<?php echo base_url();?>assets/plugins/cke-editor/adapters/adapters.min.js"></script>
    <script src="<?php echo base_url();?>assets/plugins/typed/typed.min.js"></script> <!-- Animated Typing -->
